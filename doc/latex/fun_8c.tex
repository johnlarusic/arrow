...
\subsubsection[{apply\_\-deep}]{\setlength{\rightskip}{0pt plus 5cm}int apply\_\-deep ({\bf arrow\_\-btsp\_\-fun} $\ast$ {\em fun}, \/  {\bf arrow\_\-problem} $\ast$ {\em old\_\-problem}, \/  int {\em delta}, \/  {\bf arrow\_\-problem} $\ast$ {\em new\_\-problem})}}
...
\subsubsection[{apply\_\-shallow}]{\setlength{\rightskip}{0pt plus 5cm}int apply\_\-shallow ({\bf arrow\_\-btsp\_\-fun} $\ast$ {\em fun}, \/  {\bf arrow\_\-problem} $\ast$ {\em old\_\-problem}, \/  int {\em delta}, \/  {\bf arrow\_\-problem} $\ast$ {\em new\_\-problem})}}
...
\subsubsection[{fun\_\-destruct}]{\setlength{\rightskip}{0pt plus 5cm}void fun\_\-destruct ({\bf arrow\_\-problem} $\ast$ {\em this})}}
