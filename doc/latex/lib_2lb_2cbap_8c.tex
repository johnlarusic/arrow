...
\item 
double \hyperlink{lib_2lb_2cbap_8c_99c7a8b71e6063f6bdc57a0adb920bd2}{lap} (\hyperlink{structarrow__problem}{arrow\_\-problem} $\ast$problem, int \hyperlink{delta-print_8c_1dfcb70b9229f2da17dd5922b87ecf2c}{delta}, int $\ast$x, int $\ast$y, int $\ast$pi, int $\ast$d, int $\ast$pred, int $\ast$label, \hyperlink{structarrow__heap}{arrow\_\-heap} $\ast$heap)
\item 
void \hyperlink{lib_2lb_2cbap_8c_b086dfbdeea8fc31342b66704b7e0259}{dijkstra} (\hyperlink{structarrow__problem}{arrow\_\-problem} $\ast$problem, int \hyperlink{delta-print_8c_1dfcb70b9229f2da17dd5922b87ecf2c}{delta}, int $\ast$x, int $\ast$y, int $\ast$pi, int s, int $\ast$t, int $\ast$d, int $\ast$pred, int $\ast$label, \hyperlink{structarrow__heap}{arrow\_\-heap} $\ast$heap)
\item 
...
\subsubsection[{augment}]{\setlength{\rightskip}{0pt plus 5cm}void augment ({\bf arrow\_\-problem} $\ast$ {\em problem}, \/  int {\em s}, \/  int {\em t}, \/  int $\ast$ {\em pred}, \/  int $\ast$ {\em x}, \/  int $\ast$ {\em y})}}
...
\subsubsection[{destruct\_\-data}]{\setlength{\rightskip}{0pt plus 5cm}void destruct\_\-data (int $\ast$$\ast$ {\em x}, \/  int $\ast$$\ast$ {\em y}, \/  int $\ast$$\ast$ {\em pi}, \/  int $\ast$$\ast$ {\em d}, \/  int $\ast$$\ast$ {\em pred}, \/  int $\ast$$\ast$ {\em label}, \/  {\bf arrow\_\-heap} $\ast$ {\em heap})}}
...
\subsubsection[{dijkstra}]{\setlength{\rightskip}{0pt plus 5cm}void dijkstra ({\bf arrow\_\-problem} $\ast$ {\em problem}, \/  int {\em delta}, \/  int $\ast$ {\em x}, \/  int $\ast$ {\em y}, \/  int $\ast$ {\em pi}, \/  int {\em s}, \/  int $\ast$ {\em t}, \/  int $\ast$ {\em d}, \/  int $\ast$ {\em pred}, \/  int $\ast$ {\em label}, \/  {\bf arrow\_\-heap} $\ast$ {\em heap})}}
...
\subsubsection[{init\_\-data}]{\setlength{\rightskip}{0pt plus 5cm}int init\_\-data (int {\em n}, \/  int $\ast$$\ast$ {\em x}, \/  int $\ast$$\ast$ {\em y}, \/  int $\ast$$\ast$ {\em pi}, \/  int $\ast$$\ast$ {\em d}, \/  int $\ast$$\ast$ {\em pred}, \/  int $\ast$$\ast$ {\em label}, \/  {\bf arrow\_\-heap} $\ast$ {\em heap})}}
...
\subsubsection[{lap}]{\setlength{\rightskip}{0pt plus 5cm}double lap ({\bf arrow\_\-problem} $\ast$ {\em problem}, \/  int {\em delta}, \/  int $\ast$ {\em x}, \/  int $\ast$ {\em y}, \/  int $\ast$ {\em pi}, \/  int $\ast$ {\em d}, \/  int $\ast$ {\em pred}, \/  int $\ast$ {\em label}, \/  {\bf arrow\_\-heap} $\ast$ {\em heap})}}
