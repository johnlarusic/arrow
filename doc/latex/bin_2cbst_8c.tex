...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}char$\ast$ {\bf desc} = \char`\"{}Constrained bottleneck spanning tree solver\char`\"{}}}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}double {\bf max\_\-length} = -1.0}}
