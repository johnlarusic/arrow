...
\subsubsection[{desc}]{\setlength{\rightskip}{0pt plus 5cm}char$\ast$ {\bf desc} = \char`\"{}Generates a sub-problem from a larger one\char`\"{}}}
...
\subsubsection[{end}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf end} = 1}}
...
\subsubsection[{start}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf start} = 0}}
...
\subsubsection[{usage}]{\setlength{\rightskip}{0pt plus 5cm}char$\ast$ {\bf usage} = \char`\"{}-i tsplib.tsp -s \# -e \#\char`\"{}}}
