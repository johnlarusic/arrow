...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void destroy\_\-data ({\bf arrow\_\-heap} $\ast$ {\em heap}, \/  int $\ast$$\ast$ {\em cur\_\-tree}, \/  int $\ast$$\ast$ {\em in\_\-heap}, \/  int $\ast$$\ast$ {\em d})}}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int init\_\-data (int {\em n}, \/  {\bf arrow\_\-heap} $\ast$ {\em heap}, \/  int $\ast$$\ast$ {\em cur\_\-tree}, \/  int $\ast$$\ast$ {\em in\_\-heap}, \/  int $\ast$$\ast$ {\em d})}}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void min\_\-span\_\-tree ({\bf arrow\_\-problem} $\ast$ {\em problem}, \/  int {\em C}, \/  int {\em exclude\_\-cost}, \/  int $\ast$ {\em cur\_\-tree}, \/  int $\ast$ {\em tree}, \/  int $\ast$ {\em max\_\-cost}, \/  double $\ast$ {\em length}, \/  {\bf arrow\_\-heap} $\ast$ {\em heap}, \/  int $\ast$ {\em in\_\-heap}, \/  int $\ast$ {\em d})}}
