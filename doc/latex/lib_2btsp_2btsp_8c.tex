...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}int feasible ({\bf arrow\_\-problem} $\ast$ {\em problem}, \/  int {\em num\_\-steps}, \/  {\bf arrow\_\-btsp\_\-solve\_\-plan} $\ast$ {\em steps}, \/  int {\em delta}, \/  int $\ast$ {\em feasible}, \/  {\bf arrow\_\-btsp\_\-result} $\ast$ {\em result})}}
